"""
Django settings for Vesperia project.
...
SECRET_KEY = '0&zd@@^21h^2y2)+r7oueh1@cp655t%yg9txwuonup!hsqe3c0'
...
WSGI_APPLICATION = 'Vesperia.wsgi.application'
