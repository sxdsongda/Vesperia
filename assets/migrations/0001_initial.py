# -*- coding: utf-8 -*-
# Generated by Django 1.10 on 2016-08-30 23:18
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('asset_type', models.CharField(choices=[('server', '\u670d\u52a1\u5668'), ('network_device', '\u7f51\u7edc\u8bbe\u5907'), ('storage', '\u5b58\u50a8\u8bbe\u5907'), ('software', '\u8f6f\u4ef6\u8d44\u4ea7'), ('others', '\u5176\u5b83\u7c7b')], default='server', max_length=64, verbose_name='\u7c7b\u578b')),
                ('name', models.CharField(help_text='\u5fc5\u586b', max_length=64, unique=True)),
                ('sn', models.CharField(help_text='\u5fc5\u586b', max_length=128, unique=True, verbose_name='\u8d44\u4ea7SN\u53f7')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('device_type', models.CharField(choices=[('router', '\u8def\u7531\u5668'), ('switch', '\u4ea4\u6362\u673a'), ('firewall', '\u9632\u706b\u5899'), ('NLB', 'NetScaler'), ('wireless', '\u65e0\u7ebfAP')], default='router', max_length=64)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('asset_type', models.CharField(blank=True, choices=[('server', '\u670d\u52a1\u5668'), ('switch', '\u4ea4\u6362\u673a'), ('router', '\u8def\u7531\u5668'), ('firewall', '\u9632\u706b\u5899'), ('storage', '\u5b58\u50a8\u8bbe\u5907'), ('NLB', 'NetScaler'), ('wireless', '\u65e0\u7ebfAP'), ('software', '\u8f6f\u4ef6\u8d44\u4ea7'), ('virtual_machine', '\u865a\u62df\u673a'), ('others', '\u5176\u5b83\u7c7b')], max_length=64, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('os_arch', models.CharField(blank=True, max_length=32, null=True, verbose_name='\u7cfb\u7edf\u67b6\u6784')),
                ('create_date', models.DateTimeField(auto_now_add=True)),
                ('update_date', models.DateTimeField(blank=True, null=True)),
                ('asset', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='assets.Asset')),
            ],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('software_type', models.CharField(choices=[('system', '\u64cd\u4f5c\u7cfb\u7edf'), ('application', '\u5e94\u7528\u8f6f\u4ef6')], default='application', max_length=64, verbose_name='\u8f6f\u4ef6\u7c7b\u578b')),
                ('platform', models.CharField(choices=[('Windows', 'Windows'), ('Linux', 'Linux'), ('MacOS', 'MacOS')], default='Windows', max_length=32, verbose_name='\u8fd0\u884c\u5e73\u53f0')),
                ('version', models.CharField(blank=True, max_length=64, null=True, verbose_name='\u8f6f\u4ef6/\u7cfb\u7edf\u7248\u672c')),
                ('language', models.CharField(choices=[('cn', '\u4e2d\u6587'), ('en', '\u82f1\u6587')], default='cn', max_length=32, verbose_name='\u8bed\u8a00')),
                ('asset', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='assets.Asset')),
            ],
            options={
                'verbose_name': '\u8f6f\u4ef6/\u7cfb\u7edf',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('capacity', models.IntegerField(blank=True, null=True, verbose_name='\u5bb9\u91cf(GB)')),
                ('storage_type', models.CharField(choices=[('ram', '\u5185\u5b58'), ('disk', '\u786c\u76d8'), ('nas', '\u7f51\u7edc\u5b58\u50a8')], default='disk', max_length=64, verbose_name='\u7c7b\u578b')),
                ('interface_type', models.CharField(choices=[('sata', 'SATA'), ('sas', 'SAS'), ('scsi', 'SCSI'), ('ddr3', 'DDR3'), ('ddr4', 'DDR4')], default='sata', max_length=16, verbose_name='\u63a5\u53e3/\u63d2\u69fd\u7c7b\u578b')),
                ('asset', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='assets.Asset')),
            ],
            options={
                'verbose_name': '\u5b58\u50a8\u8bbe\u5907',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('macaddress', models.CharField(max_length=64, verbose_name='MAC\u5730\u5740')),
                ('create_date', models.DateTimeField(auto_now_add=True)),
                ('update_date', models.DateTimeField(blank=True, null=True)),
                ('host_on', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='virtual_machine', to='assets.Server', verbose_name='\u5bbf\u4e3b\u673a')),
            ],
            options={
                'verbose_name': '\u865a\u62df\u673a',
        ...
        migrations.AddField(
            model_name='asset',
            name='idc',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='assets.IDC', verbose_name='IDC\u673a\u623f'),
        ),
        migrations.AddField(
            model_name='asset',
            name='manufacturer',
        ...
        migrations.AlterUniqueTogether(
            name='virtualmachine',
            unique_together=set([('macaddress', 'manage_ip')]),
        ),
        migrations.AlterIndexTogether(
            name='virtualmachine',
            index_together=set([('macaddress', 'manage_ip')]),
        ),
        migrations.AlterUniqueTogether(
            name='ram',
